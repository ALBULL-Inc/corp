...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { content: @party.content, enable: @party.enable, name: @party.name } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { content: @party.content, enable: @party.enable, name: @party.name } }
